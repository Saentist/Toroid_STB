...
$body .= <<<END
		...
		{$paged_data['links']}
			...
			<td><a href="{$_SERVER[PHP_SELF]}?orderby=callsign">callsign</a></td>
			<td><a href="{$_SERVER[PHP_SELF]}?orderby=ip">ip</a></td>
			<td><a href="{$_SERVER[PHP_SELF]}?orderby=port">port</a></td>
...
if($_GET[action] != null) {
	...
	$form = array(
			...
			array('label' => "$section Call Sign", 'type' => 'text', 'name' => 'callsign', 'value' => $edit[callsign], 'br' => '<BR />'),
			array('label' => 'IP', 'type' => 'text', 'name' => 'ip', 'value' => $edit[ip]),
			array('label' => 'Port', 'type' => 'text', 'name' => 'port', 'value' => $edit[port], 'br' => '<BR />'),
