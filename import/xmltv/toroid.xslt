...
<xsl:template match="tv/channel">
	INSERT INTO t_sd_channels (id, name) VALUES ('<xsl:value-of select="@id"/>', '<xsl:value-of select="./display-name"/>');
</xsl:template>
